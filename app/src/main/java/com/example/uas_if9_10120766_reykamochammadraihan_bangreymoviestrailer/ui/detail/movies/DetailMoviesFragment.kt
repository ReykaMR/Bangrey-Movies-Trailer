...
import com.example.uas_if9_10120766_reykamochammadraihan_bangreymoviestrailer.databinding.FragmentDetailMoviesBinding
...
class DetailMoviesFragment(idContent: String?) : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        fragmentDetailMoviesBinding.shimmerFrameLayout.startShimmer()
    }

    override fun onPause() {
        fragmentDetailMoviesBinding.shimmerFrameLayout.stopShimmer()
        super.onPause()
    }
