...
import com.example.uas_if9_10120766_reykamochammadraihan_bangreymoviestrailer.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        fragmentHomeBinding.shimmerFrameLayout.startShimmer()
    }
        ...
        if (activity != null){
            ...
            viewModel.getTVShowPopular().observe(viewLifecycleOwner, { show ->
                ...
                if (show.status == Resource.Status.SUCCESS) {
                    fragmentHomeBinding.shimmerFrameLayout.stopShimmer()
